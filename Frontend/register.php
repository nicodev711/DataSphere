...
<main class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h1 class="mb-4 text-center" id="register-title">Register</h1>
            <div class="card" style="border: none; background-color: var(--color3)">
                <div class="card-body" style="background: linear-gradient(135deg, #02a7a9, #04BAC5, #02a7a9);border-radius: 20px;">
                    <form method="post" action="../Backend/registerUser.php">
                        <div class="mb-3">
                            <label for="inputFirstName" class="form-label"><h5 class="m-0" style="color: var(--color2)">First Name</h5></label>
                            <input type="text" class="form-control" id="inputFirstName" name="inputFirstName">
                        </div>
                        <div class="mb-3">
                            <label for="inputLastName" class="form-label"><h5 class="m-0" style="color: var(--color2)">Last Name</h5></label>
                        ...
                        <div class="mb-3">
                            <label for="inputPasswordVerif" class="form-label"><h5 class="m-0" style="color: var(--color2)">Password Verification</h5></label>
                            <input type="password" class="form-control" id="inputPasswordVerif" name="inputPasswordVerif">
                        </div>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="checkTerms">
                            <label class="form-check-label" for="checkTerms"><h6>I agree to the terms and conditions</h6></label>
                        </div>
